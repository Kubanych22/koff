...
export class Cart {
  ...
  updateCart(id, quantity) {
    ...
    this.cartData.totalPrice = this.cartData.products.reduce((acc, item) =>
  ...
  renderPlace() {
    ...
    this.cartPlaceCount.classList.add('cart__place-price');
  ...
  renderForm() {
    ...
    const deliveyInput = document.createElement('input');
    deliveyInput.classList.add('radio__input');
    deliveyInput.type = 'radio';
    deliveyInput.name = 'deliveryType';
    deliveyInput.value = 'delivery';
    deliveyInput.required = true;
    deliveyInput.checked = true;
    deliveryLabel.append(deliveyInput, deliveryLabelText);
    ...
    radioPaymentFieldSet.classList.add('form-order__fieldset', 'orm-order__fieldset_radio');
